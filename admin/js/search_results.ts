...
var table = <HTMLTableElement>document.getElementById("table_results");
...
while (responseJSON["questions"][i]){
    ...
    while (responseJSON["questions"][i]["answer"+j]){
        ...
        if (responseJSON["questions"][i]["answer"+j] == "/*empty*/"){
            text_pole.innerHTML = "-";
        }else text_pole.innerHTML = responseJSON["questions"][i]["answer"+j];
    ...
    } else body_cell.className = "correct";
