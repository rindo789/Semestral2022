...
function DeleteQuestion(value){
  ...
  function CreateQuestionShow(qType,qName) {
    //zvacsi cislo otakzky
    questionIncrement();
    ...
    /*switch (questionType){
        case "one":
          CreateOptionShow(qType,CisloOtazky,oName,oCorrect);
            MoreOptions.setAttribute("onclick","CreateOption('one',this.value)");
            Hidden.value = "radio";
            break;
        case "multi":
          CreateOptionShow(qType,CisloOtazky);
            MoreOptions.setAttribute("onclick","CreateOption('multi',this.value)");
            Hidden.value = "checkbox";
            break;
        case "text":
  ...
  function CreateOptionShow(qType, oName, oCorrect){
    //konštruktory    
    const CisloOtazky = questionReturnNum();
    var SpravnyField = document.getElementById("fieldset"+CisloOtazky);
    var Option = document.createElement("input");
    ...
    Option.name = /*"question"+CisloOtazky;*/ /*"test["+CisloOtazky+"][correct]"*/ /*"correct"+CisloOtazky*/ "test["+CisloOtazky+"][correct]";
    if (oCorrect=="yes") {Option.checked = true;}

    OptionName.type = "text";
    OptionName.placeholder = "možnosť";
    OptionName.value = oName;
    OptionName.name = /*"question"+CisloOtazky;*/ "test["+CisloOtazky+"][moznost]["+optionCounter+"]";
